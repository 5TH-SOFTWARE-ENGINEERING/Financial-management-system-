...
import {
  ...
  TrendingUp, TrendingDown, Search, Filter, Loader2, Eye, EyeOff, Lock, XCircle
} from 'lucide-react';
...
const BudgetItemsListPage: React.FC = () => {
  ...
  const budgetIdParam = searchParams?.get('budget_id') ?? null;
    ...
    try {
      ...
      const errorMessage =
        ...
        (typeof error === 'object' &&
          ...
          typeof (error as { message?: string }).message === 'string'
          ? (error as { message?: string }).message
          : 'Failed to delete budget item') || 'Failed to delete budget item';
                ...
                <ModalContent onClick={(e) => e.stopPropagation()}>
                  ...
                  {itemToDelete && (
                    <div style={{
                      ...
                      <h4 style={{
                        ...
                        {itemToDelete.type === 'revenue' ? <TrendingUp size={18} /> : <TrendingDown size={18} />}
                      ...
                      <div style={{ display: 'flex', flexDirection: 'column', gap: theme.spacing.md }}>
                        <div style={{ display: 'flex', alignItems: 'flex-start', gap: theme.spacing.md, flexWrap: 'wrap' }}>
                          <div style={{ flex: '1 1 200px' }}>
                            <strong style={{ display: 'block', fontSize: theme.typography.fontSizes.xs, color: TEXT_COLOR_MUTED, marginBottom: theme.spacing.xs, textTransform: 'uppercase', letterSpacing: '0.5px' }}>Item Name</strong>
                  ...
                  <FormGroup>
                    <Label htmlFor="delete-password">
                      ...
                      Enter <strong>your own password</strong> to confirm deletion of <strong>{itemToDelete?.name || 'this budget item'}</strong>:
                    </Label>
