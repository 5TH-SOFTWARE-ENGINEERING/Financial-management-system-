...
backend/
├── model/                    ✅ Trained models (.pkl, .keras)
├── store/                    ✅ Model metadata & auto-learn state
...
├── app/
│   └── services/
│       ├── ml_forecasting.py      ✅ Core ML logic
│       ├── ml_auto_learn.py       ✅ Auto-learning
│       └── ml_advanced_training.py ✅ Advanced features
├── logs/                     ✅ Application logs
├── import_csv_data.py        ✅ Data import utility
